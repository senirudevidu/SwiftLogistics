...
const NAV_SECTIONS = [
  {
    label: 'Platform',
    items: [
      { label: 'Dashboard', path: '/client/dashboard', icon: <IconDashboard /> },
    ],
  },
  {
    label: 'Orders',
    items: [
      { label: 'My Orders',  path: '/client/orders',    icon: <IconOrders /> },
      { label: 'New Order',  path: '/client/new-order', icon: <IconPlus />  },
    ],
  },
  {
    label: 'Account',
    items: [
      { label: 'Profile', path: '/client/profile', icon: <IconUser /> },
    ],
  },
]
...
export default function ClientSidebar() {
  ...
  return (
    <aside className="admin-sidebar" aria-label="Client navigation">
